...
locals {
  ...
  query_params = var.query_params != "" ? var.query_params : "nameserver0=${var.nameserver0}&nameserver1=${var.nameserver1}&nameserver2=${var.nameserver2}&nameserver3=${var.nameserver3}"
}